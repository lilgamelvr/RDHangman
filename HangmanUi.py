...
class HangmanGame:
    def __init__(self, master):
        ...
        self.word_list = ["lister", "kryten", "cat", "rimmer", "starbug", "kochanski", "holly", "hilly", "duane dibbley"
            , "red dwarf", "ace rimmer", "hollister", "queeg", "skutter", "smeghead"]
    ...
    def update_hangman_canvas(self):
        ...
        stages = [self.draw_head, self.draw_body, self.draw_left_arm, self.draw_right_arm, self.draw_left_leg,
                  self.draw_right_leg, self.draw_face]
    ...
    def setup_alphabet_buttons(self):
        ...
        upper_row = alphabet[:14]  # First half of the alphabet
        lower_row = alphabet[14:]  # Second half of the alphabet
